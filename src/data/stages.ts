...
export const BLEACH_EVENT_STAGES: Stage[] = [
  ...
  {
    id: 'bleach_ura_1',
    name: '虚圏 裏・第1ステージ (夜の狭間)',
    enemyName: '【裏・虚圏王】完全虚化・黒崎一護(暴走)',
    enemyHp: 500000000,
    enemyAtk: 1500,
    enemyColor: '#18181b',
    enemyEmoji: '👹🖤⚡',
    rewardMoney: 250000,
    rewardYPoints: 800,
    areaName: '虚圏（ウェコムンド）裏ステージ',
    isHidden: true,
  },
  {
    id: 'bleach_ura_2',
    name: '虚圏 裏・第2ステージ (無間獄)',
    enemyName: '【裏・神域超越】山本元柳斎重國(卍解・残火の太刀)',
    enemyHp: 1000000000,
    enemyAtk: 2200,
    enemyColor: '#7f1d1d',
    enemyEmoji: '🔥⚔️👴',
  ...
  {
    id: 'bleach_ura_3',
    name: '虚圏 裏・最深部 (因果律の果て)',
    enemyName: '【全能真理・最終超越神】藍染惣右介（完全神化・因果律崩壊）',
    enemyHp: 3000000000,
    enemyAtk: 3500,
    enemyColor: '#2e004f',
    enemyEmoji: '👑🌌⚡💎',
